                ...
                <div className="primary-box min-h-[100px]">
                    <div className="flex gap-2 items-start">
                        ...
                        <div>
                            ...
                            <p className="mt-1">If number ends in 0 or is even (= number is divisible by 2)</p>
                        </div>
                    </div>
                </div>
                <div className="primary-box min-h-[100px]">
                    <div className="flex gap-2 items-start">
                        ...
                        <div>
                            ...
                            <p className="mt-1">If the sum of digits is divisible by 3</p>
                        </div>
                    </div>
                </div>
                <div className="primary-box min-h-[100px]">
                    <div className="flex gap-2 items-start">
                        ...
                        <div>
                            ...
                            <p className="mt-1">If the last two digits form a number divisible by 4</p>
                        </div>
                    </div>
                </div>
                <div className="primary-box min-h-[100px]">
                    <div className="flex gap-2 items-start">
                        ...
                        <div>
                            ...
                            <p className="mt-1">If number ends in 0 or 5</p>
                        </div>
                    </div>
                </div>
                <div className="primary-box min-h-[100px]">
                    <div className="flex gap-2 items-start">
                        ...
                        <div>
                            ...
                            <p className="mt-1">If number is divisible by both 2 and 3</p>
                        </div>
                    </div>
                </div>
                <div className="primary-box min-h-[100px]">
                    <div className="flex gap-2 items-start">
                        ...
                        <div>
                            ...
                            <p className="mt-1">Double the last digit and subtract it from the rest of the number. The result must be divisible by 0 or 7</p>
                        </div>
                    </div>
                </div>
                <div className="primary-box min-h-[100px]">
                    <div className="flex gap-2 items-start">
                        ...
                        <div>
                            ...
                            <p className="mt-1">If last 3 digits form a number divisible by 8</p>
                        </div>
                    </div>
                </div>
                <div className="primary-box min-h-[100px]">
                    <div className="flex gap-2 items-start">
                        ...
                        <div>
                            ...
                            <p className="mt-1">If sum of digits is divisible by 9</p>
                        </div>
                    </div>
                </div>
            </div>
